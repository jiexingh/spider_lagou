...
class HandleLaGou(object):
    ...
    def handle_city_job(self, city):
        first_request_url = "https://www.lagou.com/jobs/list_python?" \
                            "city=%s&cl=false&fromSearch=true&labelWords=&suginput="%city
        ...
        # 由于没有岗位信息造成的exception
            ...
            for i in range(1, int(total_page)+1):
                ...
                referer_url = "https://www.lagou.com/jobs/list_python?" \
                              "city=%s&cl=false&fromSearch=true&labelWords=&suginput="%city
                ...
                job_list = la_gou_data['content']['positionResult']['result']
                for job in job_list:
                    la_gou_mysql.insert_item(job)
